...
The "Celerium.DattoRMM" team and community take all security bugs in "Celerium.DattoRMM" seriously. Thank you for improving the security of "Celerium.DattoRMM". We appreciate your efforts and responsible disclosure and will make every effort to acknowledge your contributions.
...
- "Celerium.DattoRMM" will confirm the problem and determine the affected versions.
- "Celerium.DattoRMM" will audit code to find any potential similar problems.
- "Celerium.DattoRMM" will prepare fixes for all releases still under maintenance. These fixes will be released as fast as possible.
