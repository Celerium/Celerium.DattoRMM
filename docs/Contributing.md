...
[Source Contributing Guide](https://github.com/Celerium/Celerium.DattoRMM/blob/master/.github/CONTRIBUTING.md)
...
* **Ensure the bug was not already reported** by searching on GitHub under [Issues](https://github.com/Celerium/Celerium.DattoRMM/issues).
