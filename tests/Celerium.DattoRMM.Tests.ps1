...
.NOTES
    ...
    NAME: Celerium.DattoRMM.Tests.ps1
    Type: PowerShell
...
.SYNOPSIS
    Pester tests for the Celerium.DattoRMM module manifest file
...
Describe "Testing the [ $buildTarget ] version of [ $moduleName ] with [ $pester_TestName ]" {
    ...
    Context "[ $moduleName.psd1 ] general manifest data" {
        ...
        It "Manifest [ RootModule ] has valid data" {
            $Module.RootModule | Should -Be 'Celerium.DattoRMM.psm1'
        }
        ...
        It "Manifest [ Copyright ] has valid data" {
            $Module.Copyright | Should -Be 'https://github.com/Celerium/Celerium.DattoRMM/blob/master/LICENSE'
        }
        ...
        It "Manifest [ NestedModules ] has valid data" {
            switch ($buildTarget) {
                ...
                'notBuilt'  { ($Module.NestedModules.Name).Count | Should -Be 57 }
            }
        }

        It "Manifest [ FunctionsToExport ] has valid data" {
            ($Module.ExportedCommands).Count | Should -Be 58
        }
        ...
        It "Manifest [ Tags ] has valid data" {
            $Module.PrivateData.PSData.Tags | Should -Contain 'DattoRMM'
            ($Module.PrivateData.PSData.Tags).Count | Should -BeGreaterOrEqual 10
        }

        It "Manifest [ LicenseUri ] has valid data" {
            $Module.LicenseUri | Should -Be 'https://github.com/Celerium/Celerium.DattoRMM/blob/master/LICENSE'
        }

        It "Manifest [ ProjectUri ] has valid data" {
            $Module.ProjectUri  | Should -Be 'https://github.com/Celerium/Celerium.DattoRMM'
        }

        It "Manifest [ IconUri ] has valid data" {
            $Module.IconUri  | Should -Be 'https://raw.githubusercontent.com/Celerium/Celerium.DattoRMM/refs/heads/main/.github/images/PoSHGallery_Celerium.DattoRMM.png'
        }

        It "Manifest [ ReleaseNotes ] has valid data" {
            $Module.ReleaseNotes  | Should -Be 'https://github.com/Celerium/Celerium.DattoRMM/blob/master/README.md'
        }
