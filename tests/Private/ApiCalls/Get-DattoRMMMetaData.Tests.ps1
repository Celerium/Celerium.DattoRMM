<#
    .SYNOPSIS
        Pester tests for the Celerium.DattoRMM PLACEHOLDER functions
    ...
    .EXAMPLE
        Invoke-Pester -Path .\Tests\Private\PLACEHOLDER\Get-DattoRMMPlaceholder.Tests.ps1

        Runs a pester test and outputs simple results

    .EXAMPLE
        Invoke-Pester -Path .\Tests\Private\PLACEHOLDER\Get-DattoRMMPlaceholder.Tests.ps1 -Output Detailed
